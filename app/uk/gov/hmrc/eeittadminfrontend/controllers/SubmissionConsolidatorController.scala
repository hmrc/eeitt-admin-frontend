...
class SubmissionConsolidatorController @Inject() (
  frontendAuthComponents: FrontendAuthComponents,
  submissionConsolidatorConnector: SubmissionConsolidatorConnector,
  messagesControllerComponents: MessagesControllerComponents,
  submission_consolidator: uk.gov.hmrc.eeittadminfrontend.views.html.submission_consolidator
      ...
      manualConsolidationForm
        ...
        .fold(
          form => {
            ...
            Future.successful(BadRequest(submission_consolidator(form)))
          },
          form => {
            logger.info(
              s"User $username triggered consolidaton [consolidatorJobId=${form.consolidatorJobId}, startDate=${form.startDate}, endDate=${form.endDate}]"
            )
